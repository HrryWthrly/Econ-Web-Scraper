...
def inflation():
    ...
    article = section.find('article', class_="tile tile__content col col--md-14 margin-left-md--1 margin-bottom-md--2 height-md--52")
...
def gdp():
    article = soup.find_all('article', class_="tile tile__content col col--md-14 margin-left-md--1 margin-bottom-md--2 height-md--52")
